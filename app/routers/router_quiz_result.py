...
@router_quiz_result.get("/company/{company_id}/users/analytics", tags=["Analytics"], response_model=list)
...
@router_quiz_result.get("/company/{company_id}/user/{user_id}/quizzes-averages", tags=["Analytics"], response_model=list)
...
@router_quiz_result.get("/user/me/get-quizzes-averages", tags=["Analytics"], response_model=list)
...
@router_quiz_result.get("/user/me/get-quizzes_and-times", tags=["Analytics"], response_model=dict)
...
@router_quiz_result.get("/company/{company_id}/get-last-time", tags=["Analytics"], response_model=list)
